...
public class EADTest2 {
	private Scanner leitor;
    private int opcao;
    private AVL corrente;
    ...
    public void montarPainel(String titulo, AVL arvore) throws InterruptedException {
